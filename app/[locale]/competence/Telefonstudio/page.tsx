...
export default function Telefonstudio(){
    return (
            ...
            <div className="container mx-autogap-6 space-y-6 px-5 overflow-hidden">
                <PageSwitcher>
                    ...
                    <PageContainer pageNumber={1}>
                        <div className="w-full space-y-2">
                            <p className="col-span-3 lg:col-span-12">
                                Unsere Interviewer werden permanent inhaltlich und technisch geschult. Vor jeder Studie findet zusätzlich eine Fragebogeneinweisung durch die Studioleitung statt, um auf Besonderheiten hinzuweisen und die Interviewer für relevante Sachverhalte zu sensibilisieren.
                            </p>

                            <p className="col-span-3 lg:col-span-12">
                                {'C.M.R. verwendet bei repräsentativen Telefon-Umfragen die von der "Arbeitsgemeinschaft ADM-Telefonstichproben" zur Verfügung gestellten Stichproben- und Telefonnummernstämme. Dies gewährleistet insbesondere auch die Erreichbarkeit von Haushalten, deren Telefonnummer nicht eingetragen ist (Stichwort: Zufallsgenerierung).'}
                            </p>
                        </div>
                    </PageContainer>
                </PageSwitcher>
