    ...
    <div className="mx-[12vw]">
      ...
      <div className="flex justify-normal my-12 gap-10 flex-col lg:flex-row">
        <div className=" flex flex-col gap-9 lg:w-1/2">
          ...
          <p>
            Außerdem weist Market Structure das Markt-Potenzial für Marken bzw.
            <br />
            Marken-Familien aus.
          </p>
          ...
          <p>
            Dieses Instrument setzt bei der Erfahrungs- und Verhaltensebene von
            Konsumenten an.
          </p>
          <p>
            Eruiert wird nicht die Idealvorstellung eines Produkts, sondern es
            werden Probleme beim bisherigen Umgang mit Produkten oder
            Dienstleistungen aufgespürt, für die Lösungsansätze erarbeitet
            werden.
          </p>
          <p className="font-medium text-xl">
            © C.M.R. – Perceptual Study Hörfunk
          </p>
          <p>
            Mit einer Perceptual Study wird das Musik- und das Programm-Image
            ermittelt. Eine neue Methodik dient speziell zur besseren Erfassung
            des Musik-Images.
          </p>
          <p>
            Die Auswertung beinhaltet die Darstellung des gegenwärtigen
            Hörer-Potenzials und potenzielle Entwicklungsmöglichkeiten.
          </p>
          <p className="font-medium text-xl">
            © C.M.R. – Audiometer*Commercial{" "}
          </p>
          <p>
            Für Werbewirkungs-Untersuchungen im Hörfunk-Bereich wurde Audiometer
            entwickelt. Sein Einsatz erfolgt zur Evaluierung sowie als Pre- und
            Posttest von Radio-Spots.
          </p>
          <p>
            Charakteristisch ist, dass der zu testende Spot nicht isoliert von
            seinem Medium bewertet wird.
          </p>
          <p>
            Hauptergebnisse sind die Durchsetzungsfähigkeit eines Spots und
            seine emotionale Stimulanz.
          </p>
        </div>
        <div className=" flex flex-col gap-9 lg:w-1/2">
          <p className="font-medium text-xl">
          ...
          <p>
            Die Emotions- und Motiv-Typologie von C.M.R. weist 7 verschiedene
            Typen aus, die auf der Gefühlsebene und den Wertevorstellungen von
            Konsumenten ansetzt.
          </p>
          <p>
          ...
          <p>
            Mood & Emotion basiert auf der emotionalen Beurteilung von Marken,
            zeigt bei Einbeziehung von Werbeträgern in die Untersuchung,
            inwieweit diese das Markenimage bestätigen oder verändern.
          </p>
          <p className="font-medium text-xl">© C.M.R. – RegioTrack</p>
          <p>
            RegioTrack ermöglicht durch die Verknüpfung unterschiedlicher Daten
            hochwertige Standort-Analysen.
          </p>
          <p>
            RegioTrack ist geeignet für die Evaluierung bestehender Standorte,
            für Planungsprozesse (Neueröffnungen) oder Verlagerung von
            bisherigen Filialen sowie zur Beurteilung eines Vertriebsnetzes.
          </p>
          <p>
            Haupt-Einsatzgebiete für RegioTrack sind Handelseinrichtungen,
            Banken / Versicherungen, Transport / Verkehr sowie der Bereich
          ...
          <p>
            Eine Perceptual Study Print zeigt das Image einer Zeitung oder
            Zeitschrift bei Lesern, aber auch Nicht-Lesern.{" "}
          </p>
          <p>
            Die Auswertung beinhaltet die Darstellung des aktuellen
            Leserpotenzials, seine Entwicklungstendenz sowie die Ableitung von
            konkreten Handlungsempfehlungen basierend auf einer
            Stärken-/Schwächen-Analyse.
          </p>
          <p className="font-medium text-xl">© C.M.R. – Print Rating </p>
          <p>
            Für alle Print Medien ist Print Rating das Monitoring Instrument, um
            über einen definierten Zeitraum die Nutzungsintensität der einzelnen
            Beiträge durch die Leser zu ermitteln.{" "}
          </p>
          <p>
            Ein Zeitungs- oder Zeitschriften-Konzept kann am Nutzungsverhalten
            von Lesern überprüft und weiterentwickelt werden.
          </p>
        </div>
      </div>
    </div>
