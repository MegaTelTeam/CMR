        ...
        <div className="container mx-auto grid grid-cols-3 lg:grid-cols-12 grid-rows-2 gap-8 px-8 md:px:4 lg:px:2">
            ...
            <section className="relative col-span-3 lg:col-span-6 rounded-lg shadow-md w-full overflow-hidden text-md hover:shadow-lg transition-all ease-in-out duration-200">
                ...
                <p className="p-4 xl:text-lg lg-text-md">
                    <span>Unser Institut ist Mitglied im </span>
                    <NextLink href="#" className="text-cmr-gray-500 hover:underline hover:text-cmr-red-500 transition-all ease-in-out duration-200">Arbeitskreis Deutscher Markt-und Sozialforschungsinstitute e.V.</NextLink>
                    <span> (ADM) und der Arbeitsgemeinschaft ADM-Telefonstichprobe.</span>
                </p>
            </section>
            <section className="relative col-span-3 lg:col-span-6 rounded-lg shadow-md w-full overflow-hidden hover:shadow-lg transition-all ease-in-out duration-200">
                ...
                <p className="p-4 xl:text-lg lg-text-md">
                    <span>Im </span>
                    <NextLink href="#" className="text-cmr-gray-500 hover:underline hover:text-cmr-red-500 transition-all ease-in-out duration-200">Berufsverband Deutscher Markt- und Sozialforscher e.V.</NextLink>
                    <span> besteht eine persönliche Mitgliedschaft.</span>
                </p>
            </section>
        </div>
    )
