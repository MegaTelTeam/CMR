            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-center lg:justify-between gap-8 px-[74px] mb-14 flex-wrap">
                    ...
                    <div className="w-[200px] flex-shrink-0 flex flex-col gap-[18px]">
                        <h3 className="text-[#B12F3F] text-2xl font-bold">{t("contact")}</h3>
                        
                        {/* Phone 1 */}
                        <div className="flex items-center gap-2.5">
                            <FaPhoneAlt size={27} className="text-[#262626]" />
                            <span className="text-[#262626] text-base">{t("phone1")}</span>
                        </div>

                        {/* Phone 2 */}
                        <div className="flex items-center gap-2.5">
                            <FaFax size={27} className="text-[#262626]" />
                            <span className="text-[#262626] text-base">{t("phone2")}</span>
                        </div>

                        {/* Address */}
                        <div className="flex items-center gap-2.5">
                            <FaMapMarkerAlt size={27} className="text-[#262626]" />
                            <span className="text-[#262626] text-base" dangerouslySetInnerHTML={{ __html: t("address") }}></span>
                        </div>

                        {/* Email */}
                        <div className="flex items-center gap-2.5">
                            <FaEnvelope size={27} className="text-[#262626]" />
                            <span className="text-[#262626] text-base">{t("email")}</span>
                        </div>

                        {/* Website */}
                        <div className="flex items-center gap-2.5">
                            <FaGlobe size={27} className="text-[#262626]" />
                            <span className="text-[#262626] text-base">{t("website")}</span>
                        </div>
                    </div>
                    ...
                    <div className="w-[432px] flex-shrink-0 flex flex-col gap-4">
                        <form action={sendEmail} method="post" className="flex flex-col gap-4">
                            ...
                            {/* Send Button */}
                            <button type="submit" className="w-full py-3 px-5 text-cmr-red-400 border-cmr-red-400 border-1 rounded-[10px] text-sm hover:bg-cmr-red-400 hover:text-white transition-all duration-200">{t("sendButton")}</button>
                        </form>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-7">
                    ...
                    <div className="flex items-center gap-[46px]">
                        <a href="#" className="text-black text-base hover:text-[#B12F3F] transition-colors">{t("impressum")}</a>
                        <a href="#" className="text-black text-base hover:text-[#B12F3F] transition-colors">{t("privacy")}</a>
                    </div>
                    ...
                    {/* Copyright */}
                    <p className="text-[#262626] text-base text-center">{t("copyright")}</p>
                </div>
            </div>
        </div>
    )
